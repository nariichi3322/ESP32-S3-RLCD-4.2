...
const char *const APP_VERSION = "v1.5.1";
...
bool g_battery_animation_complete = false;
...
lv_color_t *g_flip_clock_temp_trend_canvas_buf;
lv_obj_t *g_flip_clock_humi_trend_canvas;
lv_color_t *g_flip_clock_humi_trend_canvas_buf;
...
int g_last_flip_temp_trend = 99;
int g_last_flip_humi_trend = 99;
