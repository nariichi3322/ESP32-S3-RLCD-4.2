...
inline constexpr float kBatteryChargingStopVoltage = 0.012f;
inline constexpr int kBatteryChargingRiseSamples = 1;
inline constexpr int kBatteryChargingStopSamples = 3;
