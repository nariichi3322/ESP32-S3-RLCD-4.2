...
int main()
{
    ...
    assert(value.paid_credits_state == CodexPaidCreditsState::Unavailable);
    ...
    assert(value.paid_credits_state == CodexPaidCreditsState::Unavailable);
    const char payload_v3[] = "{\"v\":3,\"s\":3,\"t\":0,\"o\":0,\"r\":80,\"u\":300,\"q\":60,\"n\":1,\"R\":65,\"U\":43200,\"Q\":120,\"d\":1,\"e\":0,\"w\":2,\"p\":1,\"b\":875,\"c\":0,\"x\":0,\"a\":0}";
    assert(codex_usage_parse_status(payload_v3, strlen(payload_v3), &value) == CodexUsageParseResult::Ok);
    assert(value.paid_credits_state == CodexPaidCreditsState::Finite);
    assert(value.paid_credits_balance == 875);
    const char unlimited_v3[] = "{\"v\":3,\"s\":3,\"t\":0,\"o\":0,\"r\":80,\"u\":300,\"q\":60,\"n\":0,\"R\":0,\"U\":0,\"Q\":0,\"d\":1,\"e\":0,\"w\":2,\"p\":2,\"b\":0,\"c\":0,\"x\":0,\"a\":0}";
    assert(codex_usage_parse_status(unlimited_v3, strlen(unlimited_v3), &value) == CodexUsageParseResult::Ok);
    assert(value.paid_credits_state == CodexPaidCreditsState::Unlimited);
    const char inconsistent_v3[] = "{\"v\":3,\"s\":3,\"t\":0,\"o\":0,\"r\":80,\"u\":300,\"q\":60,\"n\":0,\"R\":0,\"U\":0,\"Q\":0,\"d\":1,\"e\":0,\"w\":2,\"p\":2,\"b\":1,\"c\":0,\"x\":0,\"a\":0}";
    assert(codex_usage_parse_status(inconsistent_v3, strlen(inconsistent_v3), &value) == CodexUsageParseResult::OutOfRange);
    const char missing_paid_v3[] = "{\"v\":3,\"s\":3,\"t\":0,\"o\":0,\"r\":80,\"u\":300,\"q\":60,\"n\":0,\"R\":0,\"U\":0,\"Q\":0,\"d\":1,\"e\":0,\"w\":2,\"c\":0,\"x\":0,\"a\":0}";
    assert(codex_usage_parse_status(missing_paid_v3, strlen(missing_paid_v3), &value) == CodexUsageParseResult::MissingField);
    const char bad_paid_state_v3[] = "{\"v\":3,\"s\":3,\"t\":0,\"o\":0,\"r\":80,\"u\":300,\"q\":60,\"n\":0,\"R\":0,\"U\":0,\"Q\":0,\"d\":1,\"e\":0,\"w\":2,\"p\":3,\"b\":0,\"c\":0,\"x\":0,\"a\":0}";
    assert(codex_usage_parse_status(bad_paid_state_v3, strlen(bad_paid_state_v3), &value) == CodexUsageParseResult::OutOfRange);
    const char bad_paid_balance_v3[] = "{\"v\":3,\"s\":3,\"t\":0,\"o\":0,\"r\":80,\"u\":300,\"q\":60,\"n\":0,\"R\":0,\"U\":0,\"Q\":0,\"d\":1,\"e\":0,\"w\":2,\"p\":1,\"b\":4294967296,\"c\":0,\"x\":0,\"a\":0}";
    assert(codex_usage_parse_status(bad_paid_balance_v3, strlen(bad_paid_balance_v3), &value) == CodexUsageParseResult::OutOfRange);
    ...
    const char bad_version[] = "{\"v\":4,\"s\":1,\"t\":0,\"o\":0,\"r\":0,\"u\":0,\"q\":0,\"d\":0,\"w\":0,\"c\":0,\"x\":0,\"a\":0}";
    ...
    assert(codex_usage_link_state(true, true, true, 1001, 1000) == CodexUsageLinkState::Linked);
    assert(codex_usage_link_state(true, true, true, UINT32_MAX - 100, 100) == CodexUsageLinkState::Linked);
    ...
    assert(codex_usage_format_credits(999999, text, sizeof(text)) && strcmp(text, "999999") == 0);
    assert(codex_usage_format_credits(1250000, text, sizeof(text)) && strcmp(text, "1250000") == 0);
    assert(codex_usage_format_credits(12500000, text, sizeof(text)) && strcmp(text, "12.5M") == 0);
