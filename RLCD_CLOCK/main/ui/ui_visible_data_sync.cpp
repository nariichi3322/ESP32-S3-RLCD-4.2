                                                    ...
                                                    bool normal_mode)
{
    ...
    state.codex_usage = normal_mode && active_page == kWorkPageCodexUsage;
    ...
    state.uses_air_quality = normal_mode && data_requirements.air_quality;
                                 ...
                                 VisibleSyncRetryState<TickType_t> &retry)
{
    ...
    bool details_missing = state.uses_extended_weather_data && cache_status &&
                           (state.uses_air_quality
                                ? !cache_status->extended_data_ready
                                : !cache_status->forecast_data_ready);
