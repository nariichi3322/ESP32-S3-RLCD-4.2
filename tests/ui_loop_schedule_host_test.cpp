...
int main()
{
    ...
    codex.secondary_quota_reset_seconds = 61;
    assert(ui_codex_wait_delay_ms(codex) == 2000);
    codex.secondary_quota_reset_seconds = 0;
    codex.now_ms = 61001;
    assert(ui_codex_wait_delay_ms(codex) == 31999);
    codex.data_valid = false;
